...
func get_all_achievements_async() -> Array[HAchievementData]:
	...
	var opts = EOS.AchievementsApi.QueryDefinitionsOptions.new()
	EOS.AchievementsApi.AchievementsInterface.query_definitions(opts)
	...
	var get_count_opts = EOS.AchievementsApi.GetAchievementDefinitionCountOptions.new()
	var achievement_count: int = EOS.AchievementsApi.AchievementsInterface.get_achievement_definition_count(get_count_opts)
	...
	for i: int in achievement_count:
		var copy_opts = EOS.AchievementsApi.CopyAchievementDefinitionV2ByIndexOptions.new()
		copy_opts.achievement_index = i

		var copy_ret = EOS.AchievementsApi.AchievementsInterface.copy_achievement_definition_v2_by_index(copy_opts)
...
func get_player_achievements_async() -> Array[HAchievementData]:
	...
	var opts = EOS.AchievementsApi.QueryPlayerAchievementsOptions.new()

	EOS.AchievementsApi.AchievementsInterface.query_player_achievements(opts)
	...
	var get_count_opts = EOS.AchievementsApi.GetPlayerAchievementCountOptions.new()
	get_count_opts.user_id = HAuth.product_user_id
	var achievements_count = EOS.AchievementsApi.AchievementsInterface.get_player_achievement_count(get_count_opts)
	_log.debug("Got player achievements: count=%s" % achievements_count)

	var achievements: Array[HAchievementData] = []
	for i in achievements_count:
		var copy_opts = EOS.AchievementsApi.CopyPlayerAchievementByIndexOptions.new()
		copy_opts.achievement_index = i
		copy_opts.target_user_id = HAuth.product_user_id

		var copy_ret = EOS.AchievementsApi.AchievementsInterface.copy_player_achievement_by_index(copy_opts)
		if not EOS.is_success(copy_ret):
...
func unlock_achievements_async(achievement_ids: Array) -> bool:
	...
	var opts = EOS.AchievementsApi.UnlockAchievementsOptions.new()
	opts.user_id = HAuth.product_user_id
	opts.achievement_ids = achievement_ids

	EOS.AchievementsApi.AchievementsInterface.unlock_achievements(opts)
