...
## Either [EOS.AchievementsApi.UNLOCK_TIME_UNDEFINED] if not unlocked or the unix timestamp of when the achievement was unlocked by the user
var unlock_time: int = EOS.AchievementsApi.UNLOCK_TIME_UNDEFINED
...
func is_unlocked() -> bool:
	return unlock_time != EOS.AchievementsApi.UNLOCK_TIME_UNDEFINED
