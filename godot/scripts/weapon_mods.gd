...
const DEFS := {
	"suppressor": {"name": "Schalldämpfer", "npc": "mechanic", "slot": "Mündung", "price": 220, "level": 3, "quest": "arrival", "weapons": ["pistol", "smg", "ak47", "marksman", "titanbreaker", "deagle", "lever_rifle"], "desc": "14 dB leiser, 15 % weniger Rückstoß; 10 % weniger Reichweite.", "mul": {"kick_pitch": 0.85, "kick_yaw": 0.85, "range": 0.9}, "db": -14.0, "flash": 0.15},
	...
	"ghost": {"name": "Phantom · Legendär", "npc": "secret", "slot": "Mündung", "price": 1200, "level": 10, "quest": "silent_deal", "weapons": ["pistol", "smg", "ak47", "marksman", "titanbreaker", "deagle", "lever_rifle", "cryo_smg"], "desc": "24 dB leiser, 30 % weniger Rückstoß, fast kein Mündungsblitz. Volle Reichweite.", "mul": {"kick_pitch": 0.7, "kick_yaw": 0.7}, "db": -24.0, "flash": 0.03},
	...
	"titan_core": {"name": "Titanenkern · Legendär", "npc": "secret", "slot": "Lauf", "price": 1800, "level": 16, "quest": "giant_debt", "weapons": ["marksman", "lmg", "titanbreaker", "graviton_cannon", "plasma_sniper"], "desc": "20 % mehr Schaden und ein zusätzliches Durchschussziel.", "mul": {"damage": 1.2}, "pierce": 1},
}
