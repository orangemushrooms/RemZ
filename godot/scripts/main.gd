...
func _navigation_baked() -> void:
	...
	# A long first frame (Movie Maker, a slow or busy PC, a cold disk) can leave the region's
	# empty initial mesh active, and the keys then find no reachable spot ("Please restart").
